...
//---------------------------------------
    ...
    public void createCredentials() {
		...
		for (Credentials credentials1 : credentialsList) {
			if (!credentials.getUserName().equals("zsgs")) {
				credentialsList.add(credentials);
			}
		}
	}
...
//		return interviewList.stream().filter(interview->interview.getiEmailId().equals(emailId)).toList();
	...
	public void saveCandidtes() {
		...
		try (FileWriter writer = new FileWriter("C:\\Users\\zoho\\Dbfiles\\Interview\\Candidate.json")) {
	...
	public void saveInterviewer() {
		...
		try (FileWriter writer = new FileWriter("C:\\Users\\zoho\\Dbfiles\\Interview\\Interviewer.json")) {
			writer.write(jsonString);
			writer.flush();
		} catch (IOException e) {
			e.printStackTrace();
	...
	public void saveInterview() {
		...
		try (FileWriter writer = new FileWriter("C:\\Users\\zoho\\Dbfiles\\Interview\\Interview.json")) {
			writer.write(jsonString);
			writer.flush();
		} catch (IOException e) {
			e.printStackTrace();
	...
	public void saveCompany() {
		...
		try (FileWriter writer = new FileWriter("C:\\Users\\zoho\\Dbfiles\\Interview\\Company.json")) {
			writer.write(jsonString);
			writer.flush();
		} catch (IOException e) {
			e.printStackTrace();
	...
	public void saveCredentials() {
		...
		try (FileWriter writer = new FileWriter("C:\\Users\\zoho\\Dbfiles\\Interview\\Credentials.json")) {
			writer.write(jsonString);
			writer.flush();
		} catch (IOException e) {
			e.printStackTrace();
	...
	private List<Candidate> loadCandidates()  {
		...
		try {
			File file=new File("C:\\Users\\zoho\\Dbfiles\\Interview\\Candidate.json");
			if(!file.exists()){
				file.createNewFile();
			}
		}catch (IOException e){
		...
		try (
				FileReader reader = new FileReader("C:\\Users\\zoho\\Dbfiles\\Interview\\Candidate.json")) {
	...
	private List<Interviewer> loadInterviewer()  {
		...
		try {
			File file=new File("C:\\Users\\zoho\\Dbfiles\\Interview\\Interviewer.json");
			if(!file.exists()){
				file.createNewFile();
			}
		}catch (IOException e){
		...
		try (
				FileReader reader = new FileReader("C:\\Users\\zoho\\Dbfiles\\Interview\\Interviewer.json")) {
			StringBuilder sb = new StringBuilder();
			int c;
			while ((c = reader.read()) != -1) {
				sb.append((char) c);
	...
	private List<Interview> loadInterview()  {
		...
		try {
			File file=new File("C:\\Users\\zoho\\Dbfiles\\Interview\\Interview.json");
			if(!file.exists()){
				file.createNewFile();
			}
		}catch (IOException e){
		...
		try (
				FileReader reader = new FileReader("C:\\Users\\zoho\\Dbfiles\\Interview\\Interview.json")) {
			StringBuilder sb = new StringBuilder();
			int c;
			while ((c = reader.read()) != -1) {
				sb.append((char) c);
	...
	private List<Company> loadCompany()  {
		...
		try {
			File file=new File("C:\\Users\\zoho\\Dbfiles\\Interview\\Company.json");
			if(!file.exists()){
				file.createNewFile();
			}
		}catch (IOException e){
		...
		try (
				FileReader reader = new FileReader("C:\\Users\\zoho\\Dbfiles\\Interview\\Company.json")) {
			StringBuilder sb = new StringBuilder();
			int c;
			while ((c = reader.read()) != -1) {
				sb.append((char) c);
	...
	private List<Credentials> loadCredentials()  {
		...
		try {
			File file=new File("C:\\Users\\zoho\\Dbfiles\\Interview\\Credentials.json");
			if(!file.exists()){
				file.createNewFile();
			}
		}catch (IOException e){
		...
		try (
				FileReader reader = new FileReader("C:\\Users\\zoho\\Dbfiles\\Interview\\Credentials.json")) {
			StringBuilder sb = new StringBuilder();
			int c;
			while ((c = reader.read()) != -1) {
				sb.append((char) c);
